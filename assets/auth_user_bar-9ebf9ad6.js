 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e=new In("@firebase/app"),mo="@firebase/app-compat",go="@firebase/analytics-compat",yo="@firebase/analytics",_o="@firebase/app-check-compat",vo="@firebase/app-check",bo="@firebase/auth",wo="@firebase/auth-compat",Io="@firebase/database",Ao="@firebase/database-compat",Eo="@firebase/functions",To="@firebase/functions-compat",ko="@firebase/installations",So="@firebase/installations-compat",Ro="@firebase/messaging",Po="@firebase/messaging-compat",Co="@firebase/performance",xo="@firebase/performance-compat",No="@firebase/remote-config",Do="@firebase/remote-config-compat",Oo="@firebase/storage",Lo="@firebase/storage-compat",Mo="@firebase/firestore",Vo="@firebase/firestore-compat",Uo="firebase",Fo="10.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cn="[DEFAULT]",Bo={[an]:"fire-core",[mo]:"fire-core-compat",[yo]:"fire-analytics",[go]:"fire-analytics-compat",[vo]:"fire-app-check",[_o]:"fire-app-check-compat",[bo]:"fire-auth",[wo]:"fire-auth-compat",[Io]:"fire-rtdb",[Ao]:"fire-rtdb-compat",[Eo]:"fire-fn",[To]:"fire-fn-compat",[ko]:"fire-iid",[So]:"fire-iid-compat",[Ro]:"fire-fcm",[Po]:"fire-fcm-compat",[Co]:"fire-perf",[xo]:"fire-perf-compat",[No]:"fire-rc",[Do]:"fire-rc-compat",[Oo]:"fire-gcs",[Lo]:"fire-gcs-compat",[Mo]:"fire-fst",[Vo]:"fire-fst-compat","fire-js":"fire-js",[Uo]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe=Fo;function ji(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:cn,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw de.create("bad-app-name",{appName:String(r)});if(t||(t=Ui()),!t)throw de.create("no-options");const s=gt.get(r);if(s){if(mt(t,s.options)&&mt(i,s.config))return s;throw de.create("duplicate-app",{appName:r})}const o=new Ys(r);for(const c of ln.values())o.addComponent(c);const a=new Wo(t,i,o);return gt.set(r,a),a}function Wi(n=cn){const e=gt.get(n);if(!e&&n===cn&&Ui())return ji();if(!e)throw de.create("no-app",{appName:n});return e}function he(n,e,t){var i;let r=(i=Bo[n])!==null&&i!==void 0?i:n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),_e.warn(a.join(" "));return}ke(new ye(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Se=new In("@firebase/firestore");function yt(n,...e){if(Se.logLevel<=I.DEBUG){const t=e.map(kn);Se.debug(`Firestore (${Ne}): ${n}`,...t)}}function Tn(n,...e){if(Se.logLevel<=I.ERROR){const t=e.map(kn);Se.error(`Firestore (${Ne}): ${n}`,...t)}}function Ji(n,...e){if(Se.logLevel<=I.WARN){const t=e.map(kn);Se.warn(`Firestore (${Ne}): ${n}`,...t)}}function kn(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At=new In("@firebase/auth");function uc(n,...e){At.logLevel<=I.WARN&&At.warn(`Auth (${xe}): ${n}`,...e)}function ct(n,...e){At.logLevel<=I.ERROR&&At.error(`Auth (${xe}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt extends zn{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jn(n="",e=10){let t="";for(let i=0;i<e;i++)t+=Math.floor(Math.random()*10);return n+t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl=new Ze(3e4,6e4);function Ii(){const n=Q().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function jl(n){return new Promise((e,t)=>{var i,r,s;function o(){Ii(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ii(),t(Y(n,"network-request-failed"))},timeout:zl.get()})}if(!((r=(i=Q().gapi)===null||i===void 0?void 0:i.iframes)===null||r===void 0)&&r.Iframe)e(gapi.iframes.getContext());else if(!((s=Q().gapi)===null||s===void 0)&&s.load)o();else{const a=Nc("iframefcb");return Q()[a]=()=>{gapi.load?o():t(Y(n,"network-request-failed"))},Mr(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw dt=null,e})}let dt=null;function Wl(n){return dt=dt||jl(n),dt}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ql={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Xl=500,Zl=600,eu="_blank",tu="http://localhost";class Ai{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function nu(n,e,t,i=Xl,r=Zl){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Ql),{width:i.toString(),height:r.toString(),top:s,left:o}),l=N().toLowerCase();t&&(a=Sr(l)?eu:t),kr(l)&&(e=e||tu,c.scrollbars="yes");const u=Object.entries(c).reduce((w,[h,A])=>`${w}${h}=${A},`,"");if(Rc(l)&&a!=="_self")return iu(e||"",a),new Ai(null);const p=window.open(e||"",a,u);f(p,n,"popup-blocked");try{p.focus()}catch{}return new Ai(p)}function iu(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
